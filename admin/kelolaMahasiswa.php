...
<head>
    ...
    .full-height {
        min-height: 100vh; /* Membuat halaman penuh tinggi */
        display: flex;
        flex-direction: column;
        justify-content: flex-start; /* Atur ke tengah atas */
        align-items: center;
    }
    ...
    table {
        width: 100%; /* Tabel menyesuaikan dengan container */
...
<body class="bg-light">
    ...
    <!-- Konten Utama --> 
<div class="d-flex align-items-center justify-content-center full-height" style="margin-top: 90px;">
